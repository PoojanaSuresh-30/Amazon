...
import {
  clearAuthData,
  logout,
} from "../../features/Signup/logincredentialsSlice";
      ...
      <div className="navbar1">
        ...
        <div className="search">
          ...
          <div className="dropdown">
            <button className="dropbtn" onClick={handletoprofile}>
              <RiAccountCircleFill className="userProfile" />
            </button>
            <div className="dropdown-content">
              <a href="#">
                <RiAccountPinCircleLine className="drop" />
                &nbsp;&nbsp;Manage My Account
              </a>
              <a href="#">
                <FiShoppingBag className="drop" />
                &nbsp;&nbsp;My Order
              </a>
              <a href="#">
                <IoCloseCircleOutline className="drop" />
                &nbsp;&nbsp;My Cancellations
              </a>
              <a href="">
                <IoIosStarOutline className="drop" />
                &nbsp;&nbsp;My Reviews
              </a>
              <a href="/signup">
                <BiLogOutCircle
